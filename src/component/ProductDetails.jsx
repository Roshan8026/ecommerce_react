...
const ProductDetails = ({ products }) => {
  ...
  return (
    <>
      <Navbar bg="dark" variant="dark" expand="md"> {/* Use bg and variant props for background color and dark theme */}
        <Container>
        <Link to="/products" className="navbar-brand">
            <FontAwesomeIcon icon={faArrowLeft} /> {/* Use FontAwesomeIcon component to render the icon */}
            {product.name}
          </Link>
        </Container>
      </Navbar>
